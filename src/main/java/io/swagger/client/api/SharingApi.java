...
public class SharingApi {
   ...
   * @return void
   */
  public void sharingPost (List<Permission> sharingData) throws ApiException {
    Object postBody = sharingData;
    

    // create path and map variables
    String path = "/sharing".replaceAll("\\{format\\}","json");
   ...
   * @return void
   */
  public void sharingDelete (List<Permission> sharingData) throws ApiException {
    Object postBody = sharingData;
   ...
   * @return void
   */
  public void sharingVariableNameGet (String variableName) throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "/sharing/{variableName}".replaceAll("\\{format\\}","json")
