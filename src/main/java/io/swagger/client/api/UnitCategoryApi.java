...
public class UnitCategoryApi {
  ...
  public UnitCategoryApi() {
    this(Configuration.getDefaultApiClient());
  }

  public UnitCategoryApi(ApiClient apiClient) {
   ...
   */
  public InlineResponse20015 unitCategoriesGet (String name, String createdAt, String updatedAt, Integer limit, Integer offset, String sort) throws ApiException {
    ...
    TypeRef returnType = new TypeRef<InlineResponse20015>() {};
   ...
   */
  public InlineResponse20016 unitCategoriesPost (UnitCategory body) throws ApiException {
    ...
    TypeRef returnType = new TypeRef<InlineResponse20016>() {};
   ...
   * @return InlineResponse20016
   */
  public InlineResponse20016 unitCategoriesIdGet (Integer id) throws ApiException {
    Object postBody = null;
    byte[] postBinaryBody = null;
    ...
    // create path and map variables
    String path = "/unitCategories/{id}".replaceAll("\\{format\\}","json")
