...
public class MeasurementSource   {
   ...
   **/
  public MeasurementSource name(String name) {
    this.name = name;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Name of the application or device.")
  @JsonProperty("name")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.name, measurementSource.name);
  }
