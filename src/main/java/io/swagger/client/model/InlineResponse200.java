...
public class InlineResponse200   {
  ...
  private List<TrackingReminderNotification> data = new ArrayList<TrackingReminderNotification>();
  ...
  /**
   **/
  public InlineResponse200 data(List<TrackingReminderNotification> data) {
    this.data = data;
    return this;
  }
