...
public class TrackingReminderDelete   {
   ...
   **/
  public TrackingReminderDelete id(Integer id) {
    this.id = id;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Id of the PENDING reminder to be deleted")
  @JsonProperty("id")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, trackingReminderDelete.id);
  }
