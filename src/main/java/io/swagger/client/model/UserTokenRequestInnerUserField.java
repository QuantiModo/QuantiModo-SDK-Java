...
public class UserTokenRequestInnerUserField   {
   ...
   * WordPress user ID
   **/
  public UserTokenRequestInnerUserField id(Integer id) {
    this.id = id;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "WordPress user ID")
  @JsonProperty("id")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, userTokenRequestInnerUserField.id);
  }
